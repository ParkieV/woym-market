...
async def calculate_offers_values(data: pd.DataFrame, settings, market_settings: MarketOut) -> pd.DataFrame:
    ...
    data['recommended_retail_price'] = market_settings.first_variable_for_recommended_retail_price + data['wholesale_dollar_cost_price'] + market_settings.second_variable_for_recommended_retail_price * data['wholesale_dollar_cost_price']
