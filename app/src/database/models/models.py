...
class CatalogItem(Base):
    ...
    use_promotion_price = Column(Boolean, nullable=False, default=False, server_default=False)
    wholesale_dollar_cost_price = Column(Float, nullable=True, default=None)
    supplier_available = Column(Boolean, nullable=False, default=False, server_default=False)
