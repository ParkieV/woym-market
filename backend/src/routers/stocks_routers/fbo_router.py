...
@router.post('',  dependencies=[Depends(get_current_user)], response_model=list[OfferWithStocks], summary='Данные FBO', description='Данные о FBO остатках, аггрегированные по товарам')
